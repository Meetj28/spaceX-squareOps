...
// export default async function LaunchDetailsPage({ params }: LaunchProps) {
//   const { id } = params;
...
// export default async function LaunchDetailsPage({ params }: LaunchPageProps) {
//    // @ts-ignore – Ignore TS error about params typing
//   const { id } = params;
//   let launch: Launch | null = null;
...
// NOTE: params is a Promise to match Next's PageProps (generated type expects Promise)
type LaunchPageProps = {
  params: Promise<{
    id: string;
  }>;
...
export default async function LaunchDetailsPage({ params }: LaunchPageProps) {
  // Await params because its type is Promise<{ id: string }>
